...
Then, with a nested `arrange()` call, arrange the data first by the newly-created `age_group` factor variable and then by `height_meters`, with shorter individuals first.
