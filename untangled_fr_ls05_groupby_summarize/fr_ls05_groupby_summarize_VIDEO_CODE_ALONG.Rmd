---
title: 'Notes de leçon | Regroupement et résumé des données'
output:
  html_document:
...
![Fig: summarize() et son utilisation combinée avec group_by().](images/custom_dplyr_groupby_summarize.png){width="400"}
