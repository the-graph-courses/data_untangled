...
```{r}
infant_deaths_wide <- 
  read_csv(here("ch04_data_wrangling/data/gapminder_infant_deaths.csv")) %>%
...
```{r}
euro_births_wide <- 
  read_csv(here("ch04_data_wrangling/data/euro_births_wide.csv"))
euro_births_wide
```
...
```{r}
infant_births_wide <- 
    read_csv(here("ch04_data_wrangling/data/gapminder_new_births.csv"))
...
```{r}
hiv_counts <- 
    read_csv(here("ch04_data_wrangling/data/gapminder_hiv.csv"))
...
```{r}
malaria_counts <- 
    read_csv(here("ch04_data_wrangling/data/gapminder_malaria.csv"))
